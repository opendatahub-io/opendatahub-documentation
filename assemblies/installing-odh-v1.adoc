...
[role='_abstract']
You can install Open Data Hub version 1 on your OpenShift Container Platform from the OpenShift web console. For information about installing Open Hub version 2, see link:{odhdocshome}/installing_open_data_hub/#installing-the-odh-operator-v2_installv2[Installing Open Data Hub version 2].
