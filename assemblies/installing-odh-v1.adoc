...
[role='_abstract']
This section describes how to install the Open Data Hub Operator v1.X on your OpenShift Container Platform from the OpenShift web console. For information about installing the Open Hub Operator v2.X, see link:{odhdocshome}/installing-odh/#installing-odh-v2[Installing Open Data Hub (v2)].
