...
include::modules/enabling-the-model-serving-platform.adoc[leveloffset=+1]
...
include::modules/adding-a-tested-and-verified-runtime.adoc[leveloffset=+1]
...
include::modules/setting-a-default-cluster-wide-deployment-strategy.adoc[leveloffset=+1]
