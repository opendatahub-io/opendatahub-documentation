...
In this example, you use the Kubeflow Training Operator (KFTO) and Kubeflow Training Operator Python Software Development Kit (KFTO SDK) to supervise fine-tune an LLM in {productname-long}, by using the HuggingFace SFT Trainer.
