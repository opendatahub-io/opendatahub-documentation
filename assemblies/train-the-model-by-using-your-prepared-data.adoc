...
Learn more about the KubeFlow Trainer Operator in the following {productname-short} documentation:
...
* link:https://github.com/red-hat-data-services/red-hat-ai-examples/tree/main/examples/fine-tuning/training-hub/sft[Example of Supervised Fine Tuning (SFT) with Training Hub and Kubeflow Trainer]
* link:https://github.com/red-hat-data-services/red-hat-ai-examples/tree/main/examples/fine-tuning/osft[Example of Orthogonal Subspace Fine-Tuning (OSFT) with Training Hub and Kubeflow Trainer]
