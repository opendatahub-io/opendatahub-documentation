...
<<<<<<< HEAD:assemblies/deploying-a-rag-stack-in-a-project.adoc
...
=======
* Ingest domain data into a vector database by running Docling in a data science pipeline or Jupyter notebook. This process keeps the embeddings synchronized with the source data.
>>>>>>> 2657399 (RHAI-ENG-1550 - FAISS vector store integration docs):assemblies/deploying-a-rag-stack-in-a-data-science-project.adoc
