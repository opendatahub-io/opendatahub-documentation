...
* Create a `LlamaStackDistribution` instance to enable RAG functionality. This action deploys Llama Stack and connects it to a configured vector store and inference model.
