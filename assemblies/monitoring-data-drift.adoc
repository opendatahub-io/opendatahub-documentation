...
You can use data drift monitoring metrics from TrustyAI in {productname-long} to provide a quantitative measure of the alignment between the training data and the inference data. For more information on the metrics, see https://trustyai-explainability.github.io/trustyai-site/main/trustyai-service-api-reference.html[TrustyAI service API].
