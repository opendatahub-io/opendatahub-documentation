...
In {productname-short}, you can run a Ray-based distributed workload from a notebook or from a pipeline.
...
include::modules/downloading-the-demo-notebooks-from-the-codeflare-sdk.adoc[leveloffset=+2]
include::modules/running-the-demo-notebooks-from-the-codeflare-sdk.adoc[leveloffset=+2]
