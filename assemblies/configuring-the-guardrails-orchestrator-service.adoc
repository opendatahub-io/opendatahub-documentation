...
include::modules/using-hugging-face-models-with-the-guardrails-orchestrator[leveloffset=+1]
include::modules/configuring-the-guardrails-detector-hugging-face-serving-runtime[leveloffset=+2]
include::modules/using-a-hugging-face-prompt-injection-detector-with-guardrails-orchestrator[leveloffset=+2]

//include:: 'module with HF Detector 2.21' work
