...
* *Optional* Enable the OpenTelemetry exporter for and observing metrics and tracing
...
include::modules/guardrails-orchestrator-configuring-regex.adoc[leveloffset=+1]
