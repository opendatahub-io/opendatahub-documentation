...
These features are configured in the `OdhDashboardConfig` custom resource (CR) file.
...
For example, you can show or hide some of the dashboard navigation menu options. 
To change the default settings of the dashboard, edit the `OdhDashboardConfig` CR file as described in link:{odhdocshome}/managing-resources/#editing-the-dashboard-configuration-file_dashboard[Editing the dashboard configuration file].
