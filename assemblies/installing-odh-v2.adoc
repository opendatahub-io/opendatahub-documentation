...
For information about upgrading the Open Hub Operator from version 1 to version 2, see link:{odhdocshome}/upgrading-odh/#upgrading-the-odh-operator[Upgrading the Open Data Hub Operator].
