...
For information about upgrading the Open Hub Operator from version 1 to version 2, see link:{odhdocshome}/upgrading-open-data-hub/#upgrading-the-odh-operator_upgrade[Upgrading the Open Data Hub Operator].
