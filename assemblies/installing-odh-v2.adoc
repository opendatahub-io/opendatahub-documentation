...
[IMPORTANT]
====
Data science pipelines 2.0 contains an installation of Argo Workflows. {productname-short} does not support direct customer usage of this installation of Argo Workflows. To install {productname-short} 2.10.0 with data science pipelines, ensure that no separate installation of Argo Workflows exists on your cluster.
