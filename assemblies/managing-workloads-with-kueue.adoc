...
As a cluster administrator, you can manage manage AI and machine learning workloads at scale by integrating the {rhbok-productname} with {productname-long}. This integration provides capabilities for quota management, resource allocation, and prioritized job scheduling.
