...
[role='_abstract']
Distributed workloads enable data scientists to use multiple nodes in parallel to train machine-learning models or process data more quickly.
...
include::modules/running-distributed-data-science-workloads.adoc[leveloffset=+1]
