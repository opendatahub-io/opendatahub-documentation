...
ifdef::upstream[]
If there is an existing installation of Argo workflows that is not managed by {org-name} on your cluster, installations of and upgrades to {productname-short} 2.9.0 with DSP will fail.
