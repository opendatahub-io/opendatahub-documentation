...
//To avoid this issue, Red Hat recommends streaming larger data sets from external services where possible, as opposed to downloading them. Alternatively, if you need to download larger data sets, you can proactively request more storage from your administrator, to ensure you have sufficient space. For more information, see link:https://access.redhat.com/documentation/en-us/red_hat_openshift_data_foundation/4.9/html-single/scaling_storage/index#doc-wrapper[Scaling storage].
//====
