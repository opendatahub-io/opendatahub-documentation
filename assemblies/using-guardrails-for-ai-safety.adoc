...
//Integrated example - Lemonade stand tutorial

include::modules/safeguard-your-AI-application-with-guardrails.adoc[leveloffset=+1]
include::modules/safeguard-your-AI-application-against-prompt-injections-and-harmful-content.adoc[leveloffset=+2]
