...
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/{rosa-latest-version}/html/images/creating-images#creating-images[{rosa-productname} - Creating images]
