...
For example, you can finetune a model, configure a training job to use RDMA, configure a training job to use multiple nodes and multiple GPUs per node.

include::assemblies/finetuning-a-model-by-using-kubeflow-training.adoc[leveloffset=+1]
