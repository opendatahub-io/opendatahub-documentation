...
[id="generate-synthetic-data_{context}"]
...
include::modules/performance-benchmarks-for-knowledge-tuning.adoc[leveloffset=+1]

include::modules/guided-example-build-a-kfp-pipeline-for-sdg.adoc[leveloffset=+1]
