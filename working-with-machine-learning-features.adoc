...
//uncomment and include this assembly when rbac is supported
...
<<<<<<< HEAD
include::assemblies/feature-store-integration-with-workbenches.adoc[leveloffset=+1]
=======
include::assemblies/understanding-compute-engines-in-feature-store.adoc[leveloffset=+1]

include::modules/getting-started-using-the-ray-template.adoc[leveloffset=+1]
>>>>>>> 8515000 (RHOAIENG-38763 Compute engine, Ray & spark)
