...
// Large models renamed to single-model serving platform but retaining slug to maintain links

:context: serving-small-and-medium-models
include::assemblies/serving-small-and-medium-sized-models.adoc[leveloffset=+1]
// Small and medium models renamed to multi-model serving platform but retaining slug to maintain links