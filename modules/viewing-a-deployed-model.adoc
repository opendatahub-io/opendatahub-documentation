...
. Optional: Click the *Copy* button (image:{site-baseurl}/assets/img/pages/docs/images/osd-copy.png[]) on the relevant row to copy the model's inference endpoint to the clipboard.
