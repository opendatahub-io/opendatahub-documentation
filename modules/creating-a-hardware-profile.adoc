...
====
* You have installed the relevent hardware and confirmed that it is detected in your environment.
...
[NOTE]
====
Visible features indicate where the hardware profile can be used in workbenches, during model deployment, and in Data Science Pipelines.
====
...
[NOTE]
====
For more information about CRD resources, see _Managing resources from custom resource definitions_ in the Additional Resources section.
====
...
[NOTE]
====
For more information about taints and tolerations, see _Understanding taints and tolerations_ in the Additional Resources section.
====
