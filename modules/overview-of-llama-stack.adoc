...
ifndef::upstream[]
For information about deploying Llama Stack in {productname-short}, see link:{rhoaidocshome}{default-format-url}/working_with_llama_stack/index#deploying-a-rag-stack-in-a-project_rag[Deploying a RAG stack in a project].
endif::[]
