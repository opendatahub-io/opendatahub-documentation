...
* **Vector storage connections** by connecting to external vector store providers, such as Milvus, FAISS, or PGVector, to store and query embeddings.
...
* link:https://llamastack.github.io/docs[Llama Stack documentation^]
