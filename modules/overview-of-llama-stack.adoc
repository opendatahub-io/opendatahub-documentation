...
ifndef::upstream[]
For information about how to deploy Llama Stack in {productname-short}, see link:{rhoaidocshome}{default-format-url}/working_with_llama_stack/deploying-a-rag-stack-in-a-data-science-project_rag[Deploying a RAG stack in a data science project].
endif::[]
...
.2+|VectorIO |`inline::milvus` |Enabled by default |Technology Preview
