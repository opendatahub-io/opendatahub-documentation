...
If you have an older workbench image version, update the *Version selection* field to `2024.1` or `2024.2`, as described in link:{odhdocshome}/working-on-projects/#updating-a-project-workbench_projects[Updating a project workbench].
endif::[]
...
If you have an older workbench image version, update the *Version selection* field to a compatible workbench image version, for example, `2024.1`, as described in link:{rhoaidocshome}{default-format-url}/working_on_projects/using-project-workbenches_projects#updating-a-project-workbench_projects[Updating a project workbench].
endif::[]
