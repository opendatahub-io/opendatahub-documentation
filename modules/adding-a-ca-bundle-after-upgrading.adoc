...
ifdef::upstream[]
For more information, see link:{odhdocshome}/installing_open_data_hub/#understanding-certificates_certs[Understanding certificates in {productname-short}].
endif::[]
...
ifdef::upstream[]
* You upgraded {productname-long}. If you are working in a new installation of {productname-long}, see link:{odhdocshome}/installing_open_data_hub/#adding-a-ca-bundle_certs[Understanding certificates in {productname-short}].
endif::[]
