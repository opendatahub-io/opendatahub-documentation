...
====
ifdef::self-managed[]
NOTE: The *RStudio Server* workbench image is currently unavailable for disconnected environments.
endif::[]
endif::[]
...
====
ifdef::self-managed[]
NOTE: The *CUDA - RStudio Server* workbench image is currently unavailable for disconnected environments.
endif::[]
endif::[]
|===
