...
| Code Server
| Use the Code Server notebook image to access Visual Studio Code (VS Code) IDE capabilities. Customize your notebook environment to meet your needs using a variety of VS Code extensions to add new languages, themes, debuggers, and connect to additional services. Enhance the efficiency of your data science work with VS Code syntax highlighting, auto-indentation, and bracket matching, as well as an automatic task runner for seamless automation. +
