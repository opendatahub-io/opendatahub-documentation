...
[NOTE]
====
For more information about Kueue resources, see link:{odhdocshome}/working-with-distributed-workloads/#_overview-of-kueue-resources_distributed-workloads[Overview of Kueue resources].
====
endif::[]
