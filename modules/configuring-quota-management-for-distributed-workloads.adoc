...
[NOTE]
====
In {productname-short} {vernum}, {org-name} supports only NVIDIA GPU accelerated hardware and AMD GPU accelerators for distributed workloads.
====
endif::[]
ifdef::cloud-service[]
[NOTE]
====
In {productname-short}, {org-name} supports only NVIDIA GPU accelerated hardware and AMD GPU accelerators for distributed workloads.
====
endif::[]
endif::[]
ifdef::upstream[]
