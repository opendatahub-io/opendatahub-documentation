...
[role='_abstract']
By adding an Open Data Hub instance to your project, you can access the URL for your Open Data Hub dashboard and share it with your users.
...
.Procedure
. In the OpenShift web console, select *Ecosystem* -> *Installed Operators*. 
...
.Verification
. Select *Ecosystem* -> *Installed Operators*.
. On the *Installed Operators* page, click the *Project* list and select the `pass:attributes[{dbd-config-default-namespace}]` project.
