...
.Verification
* In {openshift-platform}, go to *Workloads* -> *ConfigMaps* and open the `notebook-controller-culler-config` ConfigMap in the `redhat-ods-applications` project to verify that it
contains the following culling configuration settings:
