...
For a comprehensive tutorial that demonstrates an AI/ML workflow, see the link:https://github.com/red-hat-data-services/red-hat-ai-examples/tree/main/examples/knowledge-tuning[Knowledge Tuning example] on the {org-name} AI examples site.
