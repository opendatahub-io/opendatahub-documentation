...
ifndef::upstream[]
For more information about creating these objects, see link:{rhoaidocshome}{default-format-url}/managing_openshift_ai/managing-workloads-with-kueue#configuring-quota-management-for-distributed-workloads_kueue[Configuring quota management for distributed workloads].
endif::[]
ifdef::upstream[]
