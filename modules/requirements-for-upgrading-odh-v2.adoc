...
If you use your own Argo Workflows instance for pipelines, ensure that the version installed on your cluster is compatible with this release.
For more information, see link:https://access.redhat.com/articles/rhoai-supported-configs[Supported Configurations].
