...
* link:{rhoaidocshome}{default-format-url}/working_in_your_data_science_ide/working_in_jupyterlab#installing-python-packages-on-your-workbench_ide[Installing Python packages on your workbench]
endif::[]
