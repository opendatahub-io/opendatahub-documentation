...
* `:443/v1/embeddings`
+
NOTE: The vLLM runtime is compatible with the OpenAI REST API and TGIS gRPC API. To query the endpoints for the vLLM runtime with the TGIS gRPC API, refer to the paths that are used for the TGIS Standalone runtime.
