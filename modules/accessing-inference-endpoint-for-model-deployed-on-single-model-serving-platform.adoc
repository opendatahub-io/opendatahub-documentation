...
[NOTE]
====
For a list of paths to use with the supported runtimes, see link:{rhoaidocshome}{default-format-url}/serving-models/serving-large-models_serving-large-models#inference-endpoints[Inference endpoints].
====
endif::[]
...
[NOTE]
====
For a list of sample commands, see link:{rhoaidocshome}{default-format-url}/serving-models/serving-large-models_serving-large-models#inference-endpoints[Inference endpoints].
====
endif::[]
