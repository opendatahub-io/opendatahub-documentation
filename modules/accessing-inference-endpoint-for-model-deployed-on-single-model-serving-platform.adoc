...
----
<1> You need to add the HTTP `Authorization` header and specify a token value _only_ if you added Authorino as an authorization provider to secure your model inference endpoint.
