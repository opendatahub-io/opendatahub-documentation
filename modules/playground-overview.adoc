...
[role="_abstract"]
The Generative AI (GenAI) playground is an interactive environment within the {productname-long} dashboard where you can prototype and evaluate foundation models, custom models, and Model Control Plane (MCP) servers before you use them in an application. 
