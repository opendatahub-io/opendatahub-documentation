...
The generative AI (gen AI) playground is an interactive environment within the {productname-long} dashboard where you can prototype and evaluate foundation models, custom models, and Model Context Protocol (MCP) servers before you use them in an application. 
