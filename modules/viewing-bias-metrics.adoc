...
ifdef::upstream[]
* You configured bias metrics for your model as described in link:{odhdocshome}/monitoring-data-science-models/#configuring-bias-monitoring-for-a-model-cli_bias-monitoring[Configuring bias monitoring for a model].[Configuring bias monitoring for a model].
endif::[]
