...
ifndef::upstream[]
* You configured bias metrics for your model as described in link:{rhoaidocshome}{default-format-url}/monitoring-data-science-models/monitoring-models-for-bias#configuring-bias-monitoring-for-a-model-cli_bias-monitoring[Configuring bias monitoring for a model].
