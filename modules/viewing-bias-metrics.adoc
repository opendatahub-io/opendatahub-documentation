...
ifdef::upstream[]
* You configured bias metrics for your model as described in link:{odhdocshome}/monitoring-your-ai-systems/#creating-a-bias-metric_bias-monitoring[Creating a bias metric].
endif::[]

.Procedure
. In the {productname-short} dashboard, click *AI hub* -> *Deployments*. 
...
+
NOTE: Each time you select a metric to show on the page, an additional *Select a metric* list is displayed. This enables you to show multiple metrics on the page.
