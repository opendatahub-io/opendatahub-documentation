...
** If you did not create the project, the project creator must provide you with Admin access, as described in link:{rhoaidocshome}{default-format-url}/working_on_data_science_projects/configuring-access-to-data-science-projects_nb-server[Configuring access to data science projects].
endif::[]
ifdef::upstream[]
* You have Admin access for the data science project.
** If you created the project, you automatically have Admin access. 
** If you did not create the project, the project creator must provide you with Admin access, as described in link:{odhdocshome}/working-on-data-science-projects/#_configuring_access_to_data_science_projects[Configuring access to data science projects].
endif::[]
