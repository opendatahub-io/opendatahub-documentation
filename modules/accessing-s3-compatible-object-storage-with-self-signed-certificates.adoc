...
[NOTE]
====
You can verify your new certificate configuration by following the steps in the _{productname-short} tutorial - Fraud Detection example_. Run the script to install local object storage buckets and create connections, and then enable AI pipelines.
...
For more information about enabling AI pipelines, see link:{rhoaidocshome}{default-format-url}/openshift_ai_tutorial_-_fraud_detection_example/setting-up-a-project-and-storage#enabling-pipelines[Enabling pipelines].
====
endif::[]
