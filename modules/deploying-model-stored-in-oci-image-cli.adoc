...
ifndef::upstream[]
* You have stored a model in an OCI image as described in link:{rhoaidocshome}{default-format-url}/deploying_models/rhoai-user_rhoai-user#storing-a-model-in-oci-image_rhoai-user[Storing a model in an OCI image].
endif::[]
ifdef::upstream[]
* You have stored a model in an OCI image as described in link:{odhdocshome}/deploying-models/storing-a-model-in-oci-image[Storing a model in an OCI image].
endif::[]
