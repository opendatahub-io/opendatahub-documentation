...
After registering a base model, you can start a LAB-tuning run to create your customized large language model (LLM). During the run configuration, you will provide the following details:
