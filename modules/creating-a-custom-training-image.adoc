...
| CUDA
| 3.11
| `training:py311-cuda124-torch28`
| Python 3.11, CUDA 12.4, PyTorch 2.8.0

| KFTO
| ROCm
| 3.11
| `training:py311-rocm62-torch28`
| Python 3.11, ROCm 6.2, PyTorch 2.8.0
...
ifndef::upstream[]
+
For a complete list of the {productname-short} base training images and their preinstalled packages, see link:https://access.redhat.com/articles/rhoai-supported-configs-3.x[Supported Configurations for 3.x].
endif::[]
...
[source,bash]
----
FROM registry.redhat.io/rhoai/odh-training-rocm62-torch25-py311-rhel9
----
