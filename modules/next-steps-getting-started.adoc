...
ifdef::upstream[]
link:{odhdocshome}/working_on_data_science_projects/#working-in-your-data-science-ide[Working in your data science IDE]
endif::[]
+
...
ifdef::upstream[]
link:{odhdocshome}/working-on-data-science-projects/#working-with-data-science-pipelines[Working with data science pipelines]
endif::[]
+
