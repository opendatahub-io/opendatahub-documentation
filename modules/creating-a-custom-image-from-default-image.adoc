...
----
+
Alternatively, you can leverage OpenShift's image build capabilities by using link:https://docs.openshift.com/container-platform/4.16/cicd/builds/understanding-buildconfigs.html[BuildConfig]. 
