...
After {productname-long} is installed on a cluster, you can find the default workbench images under the `redhat-ods-applications` project in the OpenShift console.
...
* You have access to the OpenShift console for the cluster where {productname-short} is installed. 
...
. Place your custom image file in an image registry that is accessible to {productname-short}.
