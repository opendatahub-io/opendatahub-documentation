...
[role='_abstract']
To use TrustyAI for bias monitoring or data drift detection, you need to send training data for your model to TrustyAI.
...
. On the *Metrics* page, click the *Select query* list and select *Custom query*.
