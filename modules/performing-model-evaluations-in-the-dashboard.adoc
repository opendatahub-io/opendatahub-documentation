...
You can access this framework and perform model evaluations through the {productname-long} dashboard or the command line interface (CLI). 
...
. In the dashboard, click *Models* > *Start evaluation run*. The Model evaluation page appears. It contains: 
  ...
  .. A Project dropdown option you can click on to show the evaluations relating to one project instead of all projects.
...
. *Security settings*: Choose _enable_ or _disable_ from the security options for each of the following:
    .. To allow your model access to the internet to download datasets.
    .. To allow your model to trust code which is outside of the project namespace. 
+
[NOTE]
--
...
--
+
A model argument summary appears as soon as you fill in the form details.
+
