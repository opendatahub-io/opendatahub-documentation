...
ifndef::upstream[]
See link:{rhoaidocshome}{default-format-url}/working-in-your-data-science-ide/#viewing-python-packages-installed-on-your-notebook-server_{context}[Viewing Python packages installed on your notebook server] for details.
endif::[]
ifdef::upstream[]
