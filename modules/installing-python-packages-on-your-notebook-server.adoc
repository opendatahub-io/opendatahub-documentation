...
ifndef::upstream[]
See link:{rhoaidocshome}{default-format-url}/working_on_data_science_projects/working-on-data-science-projects_nb-server#viewing-python-packages-installed-on-your-notebook-server_nb-server[Viewing Python packages installed on your notebook server] for details.
endif::[]
ifdef::upstream[]
See link:{odhdocshome}/working_on_data_science_projects#viewing-python-packages-installed-on-your-notebook-server_nb-server[Viewing Python packages installed on your notebook server] for details.
endif::[]
