...
ifdef::upstream[]
link:{site-baseurl}/docs/working-on-data-science-projects#viewing-python-packages-installed-on-your-notebook-server_nb-server[Viewing Python packages installed on your notebook server] for details.
endif::[]
