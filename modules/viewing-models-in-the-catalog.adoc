...
. The *Model Catalog* page provides a high-level view of available models, including the model category, name, description, and labels such as task, license, and provider. You can also view performance benchmarks for validated models from third parties.
...
* *Community and custom models*: Additional third-party and community models configured by your administrator. This category is empty by default.
+
