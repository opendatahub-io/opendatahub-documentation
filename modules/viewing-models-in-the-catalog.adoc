...
+
You can filter the performance data with the following options: 
+
...
+
You can select a percentile value in milliseconds, for example, `P90`. You can also use the slider to set the maximum acceptable latency value in milliseconds. Click *Apply filter*.
