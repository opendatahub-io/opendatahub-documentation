...
. From the *Project* drop-down list at the top of the page, select the data science project that contains your deployed model.
...
.. In the *Maximum chunk length* field, enter the maximum number of words per chunk.  
+
...
.. In the *Chunk overlap* field, enter the number of words repeated between consecutive chunks.  
+
