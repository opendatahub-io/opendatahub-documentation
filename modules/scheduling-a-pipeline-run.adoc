...
. From the *Project* list, select the pipeline that you want to create a run for.
...
. From the *Pipeline* list, select the pipeline to create a run for. Alternatively, to create a new pipeline, click *Create new pipeline* and complete the relevant fields in the *Import pipeline* dialog.
