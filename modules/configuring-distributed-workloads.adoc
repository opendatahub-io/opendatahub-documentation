...
* You have removed all external CodeFlare Operators, as described in the Knowledgebase solution link:https://access.redhat.com/solutions/7043796[How to migrate from CodeFlare Operator to Red Hat OpenShift Data Science Cluster].
ifndef::upstream[]
