...
(Technology Preview) | `true` | When enabled, new projects automatically receive a local queue, allowing administrators to select hardware profiles configured with a default queue name and priority in their workloads.
