...
(Technology Preview) | `true` | Hides the *Settings → Environment setup → Hardware profiles* menu item in the dashboard navigation menu. To show the *Settings → Environment setup → Hardware profiles* menu item in the dashboard navigation menu, set the value to `false`.
