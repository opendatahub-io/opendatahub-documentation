...
| `spec.dashboardConfig.` +
`modelAsService` 
(Developer Preview)| `false` | Controls the ability to show or hide the *Model as a service* tab on the *AI assets endpoint* page. To show this tab, set the value to `true`.
