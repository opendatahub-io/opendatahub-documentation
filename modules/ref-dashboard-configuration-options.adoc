...
| `dashboardConfig:
disableServingRuntimeParams` | `false` | Shows the *Configuration parameters* section when deploying a model, or editing a deployed model, on the single-model serving platform. To hide this section, set the value to `true`.
| `dashboardConfig:
