...
(Technology Preview) | `false` | Shows or hides the enhanced version of the *Permissions* tab with role-based access control (RBAC) on the *Projects* page. To show this tab, set the value to `true`.
| `spec.dashboardConfig.` +
