...
| `dashboardConfig:
disableFineTuning` | `true` | Note: Do not edit the default value; this feature is not available in this version of {productname-short}.
| `dashboardConfig:
...
| `dashboardConfig:
disableModelCatalog` | `true` | Note: Do not edit the default value; this feature is not available in this version of {productname-short}.
| `dashboardConfig:
