...
| `spec.dashboardConfig.` +
`genAistudio` | `false` | Shows the *Gen AI studio* menu item in the dashboard navigation menu. To hide this menu item, set the value to `true`.
| `spec.dashboardConfig.` +
`modelAsService` | `false` | Enables the Model-as-a-Service feature in the dashboard navigation menu. To hide these menu items, set the value to `true`.
