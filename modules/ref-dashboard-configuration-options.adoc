...
| `spec.dashboardConfig.` +
`genAistudio` | `false` | Controls the ability to show or hide the *Gen AI studio* menu item in the dashboard navigation menu. To show this menu item, set the value to `true`.
| `spec.dashboardConfig.` +
`modelAsService` | `false` | Controls the ability to show or hide Model-as-a-Service options in the dashboard navigation menu. To show these options, set the value to `true`.
