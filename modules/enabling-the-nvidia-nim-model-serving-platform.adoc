...
[NOTE]
====
If you previously enabled the *NVIDIA NIM model serving platform* in {productname-short} 2.14 or 2.15, and then upgraded to 2.16, you would need to re-enter your NVIDIA AI Enterprise license key and then re-enable the NVIDIA NIM model serving platform.
====
endif::[]
