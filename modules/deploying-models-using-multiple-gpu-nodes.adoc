...
* You have specified `serving.kserve.io/deploymentMode: RawDeployment` in the `InferenceService`. Your cluster does not have to be fully configured for KServe raw deployment.
