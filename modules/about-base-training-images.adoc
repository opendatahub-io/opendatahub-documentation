...
| Ray CUDA
| If you are working with compute-intensive data science models and you want to accelerate the model performance with NVIDIA GPU support, you can use the Ray Compute Unified Device Architecture (CUDA) base image to gain access to the NVIDIA CUDA Toolkit. 
...
| If you are working with compute-intensive data science models and you want to accelerate the model performance with AMD GPU support, you can use the Ray ROCm base image to gain access to the AMD ROCm software stack. 
