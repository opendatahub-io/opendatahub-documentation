...
Registry:: A central catalog of all feature definitions and their related metadata. It allows ML enginneers and data scientists to search, discover, and collaborate on new features. The registry exposes methods to apply, list, retrieve, and delete features.
