...
NOTE: The RBAC document displays all policies available in the Feast upstream. However, {org-name} supports Group and Namespace/Data_Science_Project based authorization policies only. Role-based policies are _NOT_ supported.
