...
. Select your {productname-short} administrator groups: Under *{productname-long} administrator groups*, click the text box and select an OpenShift group. Repeat this process to define multiple administrator groups.
. Select your {productname-short} user groups: Under *{productname-long} user groups*, click the text box and select an OpenShift group. Repeat this process to define multiple user groups.
+
