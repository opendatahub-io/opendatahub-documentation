...
[id="running-distributed-data-science-workloads-from-ai-pipelines_{context}"]
= Running distributed data science workloads from AI pipelines
...
ifndef::upstream[]
* You can access a project that contains a workbench, and the workbench is running a default workbench image that contains the CodeFlare SDK, for example, the *Standard Data Science* workbench. 
For information about projects and workbenches, see link:{rhoaidocshome}{default-format-url}/working_on_projects[Working on projects].
endif::[]
ifdef::upstream[]
* You can access a project that contains a workbench, and the workbench is running a default workbench image that contains the CodeFlare SDK, for example, the *Standard Data Science* workbench. 
For information about projects and workbenches, see link:{odhdocshome}/working-on-projects[Working on projects].
endif::[]
...
.Procedure
ifndef::upstream[]
. Create a connection to connect the object storage to your project, as described in link:{rhoaidocshome}{default-format-url}/working_on_projects/using-connections_projects#adding-a-connection-to-your-project_projects[Adding a connection to your project].
endif::[]
ifdef::upstream[]
. Create a connection to connect the object storage to your project, as described in link:{odhdocshome}/working-on-projects/#adding-a-connection-to-your-project_projects[Adding a connection to your project].
endif::[]

ifndef::upstream[]
. Configure a pipeline server to use the connection, as described in link:{rhoaidocshome}{default-format-url}/working_with_ai_pipelines/managing-ai-pipelines_ai-pipelines#configuring-a-pipeline-server_ai-pipelines[Configuring a pipeline server].
endif::[]
ifdef::upstream[]
. Configure a pipeline server to use the connection, as described in link:{odhdocshome}/working-with-ai-pipelines/#configuring-a-pipeline-server_ai-pipelines[Configuring a pipeline server].
endif::[]

. Create the pipeline as follows:
...
.. Build your AI pipeline in Python code.
+
...
ifndef::upstream[]
For information about the latest available training images and their preinstalled packages, see link:https://access.redhat.com/articles/rhoai-supported-configs-3.x[Supported Configurations for 3.x].
endif::[]
...
<10> Enables the Ray client to connect to a secure Ray cluster that has mutual Transport Layer Security (mTLS) enabled. mTLS is enabled by default in the Ray component in {productname-short}.
...
ifndef::upstream[]
. Import your AI pipeline, as described in link:{rhoaidocshome}{default-format-url}/working_with_ai_pipelines/managing-ai-pipelines_ai-pipelines#importing-a-pipeline_ai-pipelines[Importing a pipeline].
endif::[]
ifdef::upstream[]
. Import your AI pipeline, as described in link:{odhdocshome}/working-with-ai-pipelines/#importing-a-pipeline_ai-pipelines[Importing a pipeline].
endif::[]

ifndef::upstream[]
. Schedule the pipeline run, as described in link:{rhoaidocshome}{default-format-url}/working_with_ai_pipelines/managing-pipeline-runs_ai-pipelines#scheduling-a-pipeline-run_ai-pipelines[Scheduling a pipeline run].
endif::[]
ifdef::upstream[]
. Schedule the pipeline run, as described in link:{odhdocshome}/working-with-ai-pipelines/#scheduling-a-pipeline-run_ai-pipelines[Scheduling a pipeline run].
endif::[]

ifndef::upstream[]
. When the pipeline run is complete, confirm that it is included in the list of triggered pipeline runs, as described in link:{rhoaidocshome}{default-format-url}/working_with_ai_pipelines/managing-pipeline-runs_ai-pipelines#viewing-the-details-of-a-pipeline-run_ai-pipelines[Viewing the details of a pipeline run].
endif::[]
ifdef::upstream[]
. When the pipeline run is complete, confirm that it is included in the list of triggered pipeline runs, as described in link:{odhdocshome}/working-with-ai-pipelines/#viewing-the-details-of-a-pipeline-run_ai-pipelines[Viewing the details of a pipeline run].
endif::[]
...
ifndef::upstream[]
You can view the run details, as described in link:{rhoaidocshome}{default-format-url}/working_with_ai_pipelines/managing-pipeline-runs_ai-pipelines#viewing-the-details-of-a-pipeline-run_ai-pipelines[Viewing the details of a pipeline run].
endif::[]
ifdef::upstream[]
You can view the run details, as described in link:{odhdocshome}/working-with-ai-pipelines/#viewing-the-details-of-a-pipeline-run_ai-pipelines[Viewing the details of a pipeline run].
endif::[]

[role='_additional-resources']
.Additional resources
ifndef::upstream[]
* link:{rhoaidocshome}{default-format-url}/working_with_ai_pipelines/[Working with AI pipelines]
endif::[]
ifdef::upstream[]
* link:{odhdocshome}/working-with-ai-pipelines/[Working with AI pipelines]
endif::[]
