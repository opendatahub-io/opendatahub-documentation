...
ifdef::upstream[]
{productname-short} includes preinstalled runtimes for KServe. For more information, see link:{odhdocshome}/configuring-your-model-serving-platform/#ref-supported-runtimes_serving-large-models[Supported model-serving runtimes].
endif::[]
