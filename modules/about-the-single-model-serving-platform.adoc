...
* *Caikit Standalone ServingRuntime for KServe*: A runtime for representing text in a numerical format in a vector database that can be used in Retrieval Augmented Generation (RAG) use cases.
