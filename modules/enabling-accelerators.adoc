...
* **IBM Spyre**: See link:https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/latest/html/managing_openshift_ai/enabling-accelerators#enabling-ibm-spyre_managing-rhoai[Enabling IBM Spyre accelerators].
endif::[]
ifdef::upstream[]
