...
.Verification
* The pipeline server that you configured is displayed in the *Pipelines* tab for the project.
* The *Import pipeline* button is available in the *Pipelines* tab for the project.
