...
MaaS tiers are defined in the `tier-to-group-mapping` ConfigMap in the `pass:attributes[{dbd-config-default-namespace}]` namespace. A tier configuration includes the following properties:
