...
You can create a TrainJob resource programmatically by using the Kubeflow SDK from an {productname-short} workbench.
...
* You can access an {productname-short} workbench with Python 3.9 or later.
...
. (Optional) Verify that real-time progress metrics are displayed for your training job. Navigate to the {productname-short} dashboard and click TrainingJobs to view these metrics.
