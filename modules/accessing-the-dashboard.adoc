...
[IMPORTANT]
==== 
If you upgraded from {productname-short} version 2.x to 3.x, the dashboard URL format changed. The previous dashboard URL no longer works. You must provide the new URL to all {productname-long} administrators and users.
====
