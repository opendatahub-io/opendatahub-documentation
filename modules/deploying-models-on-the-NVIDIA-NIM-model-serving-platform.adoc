...
.. In the *NVIDIA NIM* list, select the NVIDIA NIM model that you want to deploy.
.. In the *NVIDIA NIM storage size* field, specify the size of the cluster storage instanc to store the NVIDIA NIM model.
.. In the *Number of model server replicas to deploy* field, specify a value.
.. From the *Model server size* list, select a value.
.. In the *Accelerator* list, select the *NVIDIA GPU* accelerator.
+
