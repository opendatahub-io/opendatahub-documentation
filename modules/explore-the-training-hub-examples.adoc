...
** To clone the `https://github.com/Red-Hat-AI-Innovation-Team/training_hub.git` repository from JupyterLab, follow the steps in xref:2.4.1[Clone an example Git repository].
...
* GitHub repositories:
+
** link:http://red.ht/training_hub[red.ht/training_hub]
