...
ifndef::upstream[]
To configure monitoring for this platform, see link:{rhoaidocshome}{default-format-url}/managing_and_monitoring_models/managing_and_monitoring_models_on_the_single_model_serving_platform#configuring-monitoring-for-the-model-serving-platform_cluster-admin[Configuring monitoring for the model serving platform].
endif::[]
