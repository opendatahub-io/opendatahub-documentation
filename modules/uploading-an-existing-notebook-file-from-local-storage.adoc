...
.Procedure
. In the *File Browser* in the left sidebar of the JupyterLab interface, click *Upload Files* (image:{site-baseurl}/assets/img/pages/docs/images/jupyter-upload-file.png[Upload Files]).
