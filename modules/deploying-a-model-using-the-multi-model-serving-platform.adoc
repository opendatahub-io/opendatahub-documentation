...
... In the *Access key* field, enter your access key ID for your S3-compatible object storage provider.
... In the *Secret key* field, enter your secret access key for the S3-compatible object storage account that you specified.
