...
* To use prebuilt model caches for {productname-short} Inference Server 3.2.5 images, ensure that you add the following runtime arguments in the `args` section:
** `--max_model_len=32768`
** `--max-num-seqs=32`
