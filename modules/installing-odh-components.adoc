...
| kserve
| {org-name} Connectivity Link, cert-manager Operator, Leader Worker Set Operator
| Red Hat
...
. Select *Ecosystem* -> *Installed Operators*, and then click the *{productname-short} Operator*.
