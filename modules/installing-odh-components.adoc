...
* If you want to use the `trustyai` component, you must configure workload monitoring as described in link:{odhdocshome}/managing-and-monitoring-models/#_monitoring_models_on_the_model_serving_platform[Monitoring models on the model serving platform].
