...
* If you want to use the `trustyai` component, you must configure workload monitoring as described in link:{odhdocshome}/managing-and-monitoring-models/#managing_and_monitoring_models_on_the_model_serving_platform[Monitoring models on the model serving platform].
...
| kserve
| Red Hat Authorino Operator, Red Hat OpenShift Service Mesh Operator
| Red Hat
