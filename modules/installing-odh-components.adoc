...
* If you want to use the `trustyai` component, you must configure workload monitoring as described in link:{odhdocshome}/managing-and-monitoring-models/#monitoring_models[Monitoring models on the model serving platform].
