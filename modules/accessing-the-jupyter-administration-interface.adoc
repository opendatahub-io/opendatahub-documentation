...
ifndef::self-managed[]
* You are part of the {openshift-platform} administrator group. See link:{rhoaidocshome}{default-format-url}/installing_{url-productname-short}/adding-administrative-users-for-openshift-dedicated_install[Adding administrative users] for more information.
endif::[]
