...
ifdef::upstream[]
For information on evaluating RAG systems with Ragas in {productname-short}, see link:{odhdocshome}/evaluating-ai-systems/#evaluating-rag-systems-with-ragas_monitor[Evaluating RAG systems with RAGAS].
endif::[]
