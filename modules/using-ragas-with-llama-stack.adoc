...
* *Remote provider* for production-scale evaluations that run as {productname-short} AI pipelines.
...
ifndef::upstream[]
For information on evaluating RAG systems with Ragas in {productname-short}, see link:{rhoaidocshome}{default-format-url}/working_with_llama_stack/index#evaluating-rag-systems-with-llama-stack_rag[Evaluating RAG systems with Llama Stack].
endif::[]
ifdef::upstream[]
For information on evaluating RAG systems with Ragas in {productname-short}, see link:{odhdocshome}/working-with-llama-stack/#evaluating-rag-systems-with-llama-stack_rag[Evaluating RAG systems with Llama Stack].
endif::[]
