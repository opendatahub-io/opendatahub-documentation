...
[source,terminal]
----
oc apply -f orchestrator_cr.yaml -n <namespace>
----
...
[source,terminal]
----
$ GORCH_ROUTE_HEALTH=$(oc get routes guardrails-orchestrator-sample-health -o jsonpath='{.spec.host}' -n <namespace>)
----
+
[source,terminal]
----
