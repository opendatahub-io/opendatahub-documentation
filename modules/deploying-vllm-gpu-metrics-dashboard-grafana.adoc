...
.Prerequisites
ifdef::upstream[]
* You have deployed a Grafana metrics dashboard, as described in link:{odhdocshome}/managing-and-monitoring-models/#deploying-a-grafana-metrics-dashboard_cluster-admin[Deploying a Grafana metrics dashboard].
endif::[]
ifndef::upstream[]
* You have deployed a Grafana metrics dashboard, as described in link:{rhoaidocshome}{default-format-url}/managing_and_monitoring_models/managing_and_monitoring_models#deploying-a-grafana-metrics-dashboard_cluster-admin[Deploying a Grafana metrics dashboard].
endif::[]
...
.. To monitor NVIDIA accelerated hardware metrics, see link:https://github.com/rh-aiservices-bu/rhoai-uwm/tree/main/rhoai-uwm-grafana/overlays/rhoai-uwm-user-grafana-app/nvidia-vllm-dashboard.yaml[`nvidia-vllm-dashboard.yaml`].
