...
. Select *Ecosystem* -> *Installed Operators*, and then click the *Open Data Hub Operator*.
...
.Verification
* Select *Ecosystem* -> *Installed Operators* to verify that the *Open Data Hub Operator* is listed with the updated version number and *Succeeded* status.

.Next Steps
* Check the Open Data Hub components. For more information, see link:{odhdocshome}/upgrading-open-data-hub/#installing-odh-components_upgrade[Installing Open Data Hub components].
