...
Configure a Generative AI (GenAI) playground for your project, so that you can interact with your deployed generative AI models and connect to backend servers, such as the Model Control Protocol (MCP).
