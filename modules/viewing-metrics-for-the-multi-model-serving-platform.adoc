...
= Viewing serving runtime metrics for the multi-model serving platform

[role="_abstract"]
When a cluster administrator has configured monitoring for the multi-model serving platform, non-admin users can use the OpenShift web console to view available serving runtime metrics for the ModelMesh component. 
