...
link:https://docs.redhat.com/en/documentation/red_hat_ai/3/html-single/derp/index#rhelai-supported-ai-accelerators-for-inference-serving_supported-configurations[Derp]
