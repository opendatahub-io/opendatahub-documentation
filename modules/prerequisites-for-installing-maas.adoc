...
* You must enable the GenAI Studio menu item in the dashboard by setting `spec.dashboardConfig.genAiStudio: true` in the `OdhDashboardConfig` custom resource.
====
