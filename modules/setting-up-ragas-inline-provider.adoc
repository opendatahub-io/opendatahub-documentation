...
.Next steps
ifdef::upstream[]
* link:{odhdocshome}/working-with-llama-stack/#evaluating-rag-system-quality-with-ragas_rag[Evaluating RAG system quality with Ragas]
* link:{odhdocshome}/working-with-llama-stack/#configuring-ragas-remote-provider-for-production_rag[Configuring the Ragas remote provider for production]
endif::[]
