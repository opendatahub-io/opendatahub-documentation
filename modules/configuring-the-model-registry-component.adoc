...
ifdef::cloud-service[]
To configure the model registry feature for your data scientists to use in {productname-short}, you must install the following Operators in OpenShift, install {productname-long} as an add-on to your OpenShift cluster, and then enable the `modelregistry` component in {productname-short}.
endif::[]
...
ifdef::cloud-service[]
* You have installed {productname-long} as an add-on to your OpenShift cluster. 
...
ifdef::self-managed[]
* You have installed the {productname-long} Operator on your OpenShift cluster. 
* You have installed the {org-name} Authorino, {org-name} OpenShift Serverless, {org-name} OpenShift Service Mesh, and {org-name} OpenShift AI Operators.
