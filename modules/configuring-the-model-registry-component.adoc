...
* You have installed the {org-name} OpenShift Serverless and {productname-long} Operators.
...
ifdef::upstream[]
* You have installed the {productname-long} Operator on your {openshift-platform} cluster. 
* You have installed the {org-name} OpenShift Serverless and Open Data Hub Operators.
