...
ifndef::upstream[]
For more information about these deployment mode options, see link:{rhoaidocshome}{default-format-url}/deploying_models/rhoai-user_rhoai-user#about-kserve-deployment-modes_rhoai-user[About KServe deployment modes].
endif::[]
.. Click *Save changes*.
...
+
ifdef::upstream[]
For more information about preinstalled runtimes, see link:{odhdocshome}/deploying-models/#ref-supported-runtimes_odh-user[Supported runtimes].
endif::[]
ifndef::upstream[]
For more information about preinstalled runtimes, see link:{rhoaidocshome}{default-format-url}/deploying_models/rhoai-user_rhoai-user#ref-supported-runtimes[Supported runtimes].
endif::[]
