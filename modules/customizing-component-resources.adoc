...
[NOTE]
====
For more information about the deployment names for each component, see link:{rhoaidocshome}{default-format-url}/overview-of-component-resource-customization_resource-mgmt[Overview of component resource customization].
====
endif::[]
