...
ifndef::upstream[]
* You have configured monitoring for the model serving platform, as described in link:{rhoaidocshome}{default-format-url}/monitoring_data_science_models/configuring-trustyai_monitor#configuring-monitoring-for-your-model-serving-platform_monitor[Configuring monitoring for your model serving platform].
