...
[NOTE]
====
The `modelregistry` component is enabled by default in {productname-short} {vernum}.  
ifndef::cloud-service[]
However, if this component was not enabled in a previous version of {productname-short}, it will remain disabled after upgrading to {productname-short} {vernum}.
endif::[]
====
