...
To allow the data scientists in your organization to work with the model registry feature in {productname-short}, you must enable the `modelregistry` component in {productname-short}.
