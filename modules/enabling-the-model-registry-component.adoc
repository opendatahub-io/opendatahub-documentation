...
Before data scientists and AI engineers in your organization can work with the model registry and model catalog, you must ensure that the `modelregistry` component is enabled in {productname-short}.
