...
ifndef::upstream[]
For more information on how to format object storage endpoints, see link:{rhoaidocshome}/managing_resources/index#overview-of-object-storage-endpoints_resource-mgmt[Overview of object storage endpoints].
endif::[]
