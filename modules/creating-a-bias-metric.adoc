...
ifndef::upstream[]
For information about the specific bias metrics, see link:{rhoaidocshome}{default-format-url}/monitoring_your_ai_systems/monitoring-model-bias_bias-monitoring#using-bias-metrics_bias-monitoring[Using bias metrics]. 
endif::[]
ifdef::upstream[]
For information about the specific bias metrics, see link:{odhdocshome}/monitoring-your-ai-systems/#using-bias-metrics_bias-monitoring[Using bias metrics]. 
endif::[]
