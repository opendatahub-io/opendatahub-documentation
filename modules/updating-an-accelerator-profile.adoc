...
+
The *Workbench images* page opens. Previously imported workbench images are displayed. To enable or disable a previously imported workbench image, on the row containing the relevant workbench image, click the toggle in the *Enable* column.
