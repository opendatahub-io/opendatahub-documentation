...
====
*Disclaimer:* +
{org-name} supports managing workbenches in {productname-short}. However, {org-name} does not provide support for the RStudio software. RStudio Server is available through link:rstudio.org[https://rstudio.org/] and is subject to their licensing terms, which should be reviewed prior to use of this sample workbench. +

The *CUDA - RStudio Server* notebook image contains NVIDIA CUDA technology. CUDA licensing information is available at link:https://docs.nvidia.com/cuda/[https://docs.nvidia.com/cuda/] and should be reviewed prior to using this sample workbench.
====
endif::[]
endif::[]
