...
[role='_abstract']
You can enable NVIDIA graphics processing units (GPUs) in {productname-short} to ensure that your data scientists can use compute-heavy workloads in their models.
