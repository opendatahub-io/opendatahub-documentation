...
ifndef::upstream[]
** The user interface, see link:{rhoaidocshome}{default-format-url}/deploying_models/deploying_models#deploying-models-on-the-model-serving-platform_rhoai-user[Deploying models on the model serving platform].
** The command line interface, see link:{rhoaidocshome}{default-format-url}/deploying_models/deploying_models#deploying-model-stored-in-oci-image_rhoai-user[Deploying a model stored in an OCI image by using the CLI].
endif::[]
ifdef::upstream[]
