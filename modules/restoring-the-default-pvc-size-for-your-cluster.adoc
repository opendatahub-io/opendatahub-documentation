...
ifdef::cloud-service[]
* link:https://docs.openshift.com/dedicated/storage/understanding-persistent-storage.html[Understanding persistent storage] (OpenShift Dedicated)
* link:https://docs.openshift.com/rosa/storage/understanding-persistent-storage.html[Understanding persistent storage] (Red Hat OpenShift Service on AWS)
endif::[]
//TEST
