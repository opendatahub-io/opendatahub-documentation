...
Settings -> Notebook image settings:: The *Notebook image settings* page allows administrators to configure custom notebook images that cater to your project's specific requirements. After you have added custom notebook images to your deployment of {productname-short}, they are available for selection when creating a notebook server.
...
Settings -> User management:: The *User management* page allows administrators to define {productname-short} user group and admin group membership.
