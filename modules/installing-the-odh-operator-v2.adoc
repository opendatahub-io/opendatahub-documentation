...
. On the *Software Catalog* page, in the *Filter by keyword* field, enter `Open Data Hub Operator`.
...
.Verification
* Select *Ecosystem* -> *Installed Operators* to verify that the *Open Data Hub Operator* is listed with *Succeeded* status.
