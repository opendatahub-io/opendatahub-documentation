...
# We'll be using a llama-stack server deployed in OpenShift AI. More info at "Deploying a Llama Stack server" at 
# https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.2/html/working_with_llama_stack/deploying-llama-stack-server_rag
#
