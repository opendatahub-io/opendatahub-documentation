...
* link:{rhoaidocshome}{default-format-url}/working_in_your_data_science_ide/working_in_jupyterlab#installing-python-packages-on-your-notebook-server_{context}[Installing Python packages on your notebook server]
endif::[]
