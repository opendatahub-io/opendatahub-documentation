...
[role="_additional-resources"]
.Additional resources
* link:{odhdocshome}/working-in-your-data-science-ide/
#installing-python-packages-on-your-notebook-server_{context}[Installing Python packages on your notebook server]
endif::[]
