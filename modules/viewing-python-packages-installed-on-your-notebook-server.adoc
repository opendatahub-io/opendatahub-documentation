...
ifdef::upstream[]
* link:{site-baseurl}/docs/working-on-data-science-projects.html#installing-python-packages-on-your-notebook-server_nb-server[Installing Python packages on your notebook server]
endif::[]
