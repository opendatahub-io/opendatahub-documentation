...
ifndef::upstream[]
Based on the example configurations provided in xref:#guardrails-gateway-config-parameters_safety[Configuring the Guardrails Gateway], the available endpoint for the model with Guardrails is `$GUARDRAILS_GATEWAY/pii`.
endif::[]
