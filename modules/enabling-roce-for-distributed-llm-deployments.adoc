...
+
Configure SR-IOV (Single Root I/O Virtualization) for high-performance network interfaces:

... Install the SR-IOV Network Operator from OperatorHub.
...
* Benjamin Schmaus blog series:
** link:https://www.redhat.com/en/blog/rdma-cuda-nvidia-openshift[RDMA+CUDA with NVIDIA on OpenShift]
** link:https://www.redhat.com/en/blog/rdma-nvidia-openshift[RDMA with NVIDIA on OpenShift]
ifdef::upstream[]
