...
.Procedure
. From the {productname-short} dashboard, click *Settings* -> *Model resources and operations* -> *AI registry settings*.
...
. Optional: Select *Add CA certificate to secure database connection* to use a certificate with your database connection.
+
[IMPORTANT]
====
...
.Verification
* The model registry is displayed with updated details on the *AI registry settings* page.
