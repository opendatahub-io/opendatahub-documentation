...
You can view a graph that illustrates the HTTP requests that have failed or succeeded for a specific model that is deployed on the model serving platform.
...
* You have deployed models on the model serving platform.
