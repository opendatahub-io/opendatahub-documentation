...
[NOTE]
====
For more information, see link:https://www.redhat.com/en/topics/containers/what-Kubernetes-role-based-access-control-rbac[What is Kubernetes Role Based Access Control]? 
====
...
[NOTE]
====
For an example of a `permission.py` file, see the 
...
. Configure authentication in the {openshift-platform} web console. You have full control over your data science project access. You can grant and revoke access to users/groups instantly.
...
[NOTE]
====
The name of your group must exist in your identity provider. The identity provider is configured at the {openshift-platform} cluster level, outside of the specific Data Science Project (DSP) you are working in.
====
