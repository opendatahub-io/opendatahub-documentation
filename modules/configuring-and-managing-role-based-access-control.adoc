...
[NOTE]
====
The name of your group must exist in your identity provider. The identity provider is configured at the {openshift-platform} cluster level, outside of the specific project you are working in.
====
