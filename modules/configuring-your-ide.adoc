...
See an link:https://github.com/red-hat-data-services/notebooks/tree/inject-bd-clients-example/codeserver/ubi9-python-3.9-db-clients[example custom image folder in GitHub] for reference.
