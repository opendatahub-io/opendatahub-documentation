...
. In the *Name* field, enter a unique name for the model registry.
+
The model registry name must not match the name of any other model registry in your OpenShift cluster.
