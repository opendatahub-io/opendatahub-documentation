...
ifdef::upstream[]
To upload a certificate as a secret, you must create a secret in {openshift-platform}, in the `odh-model-registries` namespace.
endif::[]
ifndef::upstream[]
To upload a certificate as a secret, you must create a secret in {openshift-platform}, in the `rhoai-model-registries` namespace.
endif::[]
