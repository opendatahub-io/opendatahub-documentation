...
ifndef::upstream[]
* link:{rhoaidocshome}{default-format-url}/configuring-your-model-serving-platform_rhoai-admin#supported-model-serving-runtimes_rhoai-admin[Supported model-serving runtimes^]
endif::[]
ifdef::upstream[]
