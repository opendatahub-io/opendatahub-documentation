...
== IBM Spyre AI accelerators on x86_64, IBM Power, and IBM Z
ifndef::upstream[]
[IMPORTANT]
====
ifdef::self-managed[]
Support for IBM Spyre AI Accelerators on x86_64 is currently available in {productname-long} {vernum} as a Technology Preview feature.
endif::[]
ifdef::cloud-service[]
Support for IBM Spyre AI Accelerators on x86_64 is currently available in {productname-long} as a Technology Preview feature.
endif::[]
...
Support for IBM Spyre AI Accelerators on IBM Power is currently available in {productname-long} 3.3 as a General Availability (GA) feature.
endif::[]
