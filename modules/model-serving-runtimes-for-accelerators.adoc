...
[role="_abstract"]
{productname-short} includes support for NVIDIA, AMD, Intel Gaudi and Spyre accelerators. {productname-short} also includes preinstalled model-serving runtimes that provide accelerator support.
