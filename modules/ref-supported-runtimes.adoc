...
ifdef::upstream[]
* link:{odhdocshome}/serving-models/serving-large-models/ref-inference-endpoints[Inference endpoints]
endif::[]

ifndef::upstream[]
* link:{rhoaidocshome}{default-format-url}/serving-models/serving-large-models/ref-inference-endpoints[Inference endpoints]
endif::[]
