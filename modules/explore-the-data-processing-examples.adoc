...
. To access the data processing examples, use one of the following methods to clone the link:https://github.com/opendatahub-io/data-processing.git[data processing Git repository]:
+
ifdef::upstream[]
* To clone the https://github.com/opendatahub-io/data-processing.git repository from JupyterLab, follow the steps in link:{odhdocshome}/customize-models-to-build-gen-ai-applications/#clone-an-example-git-repository_custom-models[Clone an example Git repository] and specify the `stable` branch.
endif::[]
ifndef::upstream[]
