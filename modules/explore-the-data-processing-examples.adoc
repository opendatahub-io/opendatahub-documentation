...
+
* To clone the https://github.com/opendatahub-io/data-processing.git repository from JupyterLab, follow the steps in xref:2.4.1[Clone an example Git repository] and specify the 3.0 branch.
