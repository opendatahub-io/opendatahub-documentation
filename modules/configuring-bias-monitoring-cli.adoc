...
ifdef::upstream[]
* You are familiar with link:{odhdocshome}/monitoring-models-for-bias#supported-bias-metrics_bias-monitoring[the bias metrics that {productname-short} supports] and how to interpret them.
endif::[]
