...
ifndef::upstream[]
* The pipeline that you want to delete does not contain any pipeline versions. For more information, see link:{rhoaidocshome}{default-format-url}/working-with-data-science-pipelines/managing-data-science-pipelines_ds-pipelines#deleting-a-pipeline-version_ds-pipelines[Deleting a pipeline version].
endif::[]
ifdef::upstream[]
