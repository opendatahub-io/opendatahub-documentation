...
ifdef::upstream[]
* The pipeline that you want to delete does not contain any pipeline versions. For more information, see link:{odhdocshome}/working-on-data-science-projects/#_managing_data_science_pipelines[Deleting a pipeline version].
endif::[]
