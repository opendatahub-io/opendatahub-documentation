...
ifndef::upstream[]
For more information, see link:{rhoaidocshome}{default-format-url}/working_with_ai_pipelines/configuring-a-pipeline-server_ai-pipelines[Configuring a pipeline server].
endif::[]
...
ifndef::upstream[]
For more information, see link:{rhoaidocshome}{default-format-url}/working_with_rag/deploying-a-rag-stack-in-a-project_rag#Deploying-a-llama-model-with-kserve_rag[Deploying a Llama model with KServe].
endif::[]
