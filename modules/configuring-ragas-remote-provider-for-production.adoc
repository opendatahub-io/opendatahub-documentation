        ...
        - name: KUBEFLOW_BASE_IMAGE
          valueFrom:
            configMapKeyRef:
              ...
              name: <quay.io/trustyai/llama-stack-ragas:latest>
              optional: true
        - name: KUBEFLOW_LLAMA_STACK_URL
          valueFrom:
            configMapKeyRef:
              key: KUBEFLOW_LLAMA_STACK_URL
              name: "http://$<distribution_name>-service.$<your_namespace>.svc.cluster.local:$<port>"
              optional: true
        - name: KUBEFLOW_RESULTS_S3_PREFIX
          valueFrom:
            configMapKeyRef:
              key: KUBEFLOW_RESULTS_S3_PREFIX
              name: s3://<bucket_name>/ragas-results
              optional: true
