...
.. In the *Model format* section, click *Edit* to edit the model format of the model version, for example,`onnx`.
.. In the *Model format version* section, click *Edit* to edit the model format version number of the model version.
