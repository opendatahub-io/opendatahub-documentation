...
ifndef::upstream[]
* link:{rhoaidocshome}{default-format-url}/managing_openshift_ai/managing-workloads-with-kueue#troubleshooting-common-problems-with-distributed-workloads-for-administrators_kueue[Troubleshooting common problems with distributed workloads for administrators]
