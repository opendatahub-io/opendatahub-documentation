...
ifdef::upstream[]
* For model-serving runtimes, see link:{odhdocshome}/deploying-models/#deploying-models-on-the-model-serving-platform_odh-user[Deploying models].
endif::[]
ifndef::upstream[]
* For model-serving runtimes, see link:{rhoaidocshome}{default-format-url}/deploying_models/deploying_models_on_the_single_model_serving_platform#deploying-models-on-the-model-serving-platform_rhoai-user[Deploying models].
endif::[]
