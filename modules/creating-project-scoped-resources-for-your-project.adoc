...
If you cannot access an existing project-scoped resource to copy its YAML code, contact your cluster administrator to request the relevant YAML code.


.Procedure
. Log in to the {openshift-platform} console.
. Copy the YAML code provided by your cluster administrator to create the resource.
+
