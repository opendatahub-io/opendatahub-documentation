...
ifdef::upstream[]
* For workbench images, hardware profiles, and accelerator profiles, when you create a workbench in the project, as described in link:{odhdocshome}/working-on-projects/#creating-a-project-workbench_projects[Creating a workbench], the workbench image that you added is available in the *Image selection* list.
endif::[]
ifndef::upstream[]
* For workbench images, hardware profiles, and accelerator profiles, when you create a workbench in the project, as described in link:{rhoaidocshome}{default-format-url}/working_on_projects/using-project-workbenches_projects#creating-a-project-workbench_projects[Creating a workbench], the workbench image that you added is available in the *Image selection* list.
endif::[]
