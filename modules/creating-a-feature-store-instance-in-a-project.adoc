...
[id="creating-a-feature-store-instance-in-a-project_{context}"]
...
ifndef::upstream[]
* You have created a project, as described in link:{rhoaidocshome}{default-format-url}/working_on_projects/using-projects_projects#creating-a-project_projects[Creating a project]. In the following procedure, `my-ds-project` is the name of the project.
endif::[]

ifdef::upstream[]
* You have created a project, as described in link:{odhdocshome}/working-on-projects/#creating-a-project_projects[Creating a project]. In the following procedure, `my-ds-project` is the name of the project.
endif::[]
...
. Optionally, edit `feastProject`, which is the namespace for organizing your Feature Store instance. Note that this project is not the {productname-short} project.
...
* *project* — The namespace for the Feature Store instance. Note that this project refers to the feature project rather than the {productname-short} project.
