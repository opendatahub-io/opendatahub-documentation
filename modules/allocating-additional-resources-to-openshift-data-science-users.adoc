...
[id='allocating-additional-resources-to-openshift-data-science-users_{context}']
...
ifdef::self-managed[]
For more information about allocating additional resources to an OpenShift Container Platform cluster, see link:https://docs.openshift.com/container-platform/4.13/machine_management/manually-scaling-machineset.html[Manually scaling a machine set].
endif::[]
