...
.. Edit the parameters of the training job, as follows:
...
.. Apply the configuration to create the `my-config-trainingjob` object, as follows:
+
[source]
----
...
.. Apply the configuration to create the training data, as follows:
+
[source]
----
...
.. Apply the configuration to create a Persistent Volume Claim (PVC) for the training job, as follows:
+
[source]
----
