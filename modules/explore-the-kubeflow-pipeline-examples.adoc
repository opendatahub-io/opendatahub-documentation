...
. To access the link:https://github.com/opendatahub-io/data-processing/tree/main/kubeflow-pipelines[kubeflow pipeline examples], run the following command to clone the link:https://github.com/opendatahub-io/data-processing/tree/stable[data processing Git repository]:
+
[source, bash]
----
...
*NOTE:* If you want to use a Red Hat built container image in one of the above pipelines, replace the image on link:https://github.com/opendatahub-io/data-processing/blob/stable/kubeflow-pipelines/common/constants.py#L8[this line] with link:https://catalog.redhat.com/en/software/containers/rhai/docling-cuda-rhel9/696622c8c7bf8e4b645f4157#overview[the URL for the Red Hat Docling container image] and recompile the pipeline that you want to use.