...
[role='_abstract']
You can use the {openshift-cli} to delete a bias metric for a model.
...
ifdef::upstream[]
* You have a user token for authentication as described in link:{odhdocshome}/monitoring-your-ai-systems/#authenticating-trustyai-service_monitor[Authenticating the TrustyAI service].
endif::[]
