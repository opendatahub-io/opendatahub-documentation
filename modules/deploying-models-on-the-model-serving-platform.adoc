...
+
ifndef::upstream[]
For more information about how the system determines the best runtime and administrator overrides, see link:{rhoaidocshome}{default-format-url}/deploying_models/deploying_models#automatic-selection-of-serving-runtimes[Automatic selection of serving runtimes].
endif::[]
ifdef::upstream[]
For more information about how the system determines the best runtime and administrator overrides, see link:{odhdocshome}/deploying_models/#automatic-selection-of-serving-runtimes[Automatic selection of serving runtimes].
endif::[]
