...
ifndef::upstream[]
* link:{rhoaidocshome}{default-format-url}/configuring_your_model-serving_platform/configuring_model_servers_on_the_model_serving_platform#adding-a-custom-model-serving-runtime_rhoai-admin[Adding a custom model-serving runtime].
endif::[]
