...
ifdef::upstream[]
For more information about how the system determines the best runtime or administrator overrides, see link:{odhdocshome}/deploying_models/#automatic-selection-of-serving-runtimes[Automatic selection of serving runtimes].
endif::[]
