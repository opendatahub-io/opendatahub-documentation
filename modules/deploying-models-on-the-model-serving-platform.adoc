...
ifdef::upstream[]
.. In the *Deployment strategy* section, select *Rolling update* or *Recreate*. For more information about deployment strategies, see link:{odhdocshome}/deploying-models/#deployment-strategies-for-resource-optimization_odh-user[Deployment strategies for resource optimization].
endif::[]
+
[NOTE]
====
