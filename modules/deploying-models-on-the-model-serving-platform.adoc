...
[NOTE]
====
You must add your model as an AI asset endpoint to test your model in the Generative AI (Gen AI) playground.
====
+
...
ifdef::upstream[]
.. In the *Deployment strategy* section, select *Rolling update* or *Recreate*. For more information about deployment strategies, see link:{odhdocshome}/deploying_models/deploying_models#deployment-strategies-for-resource-optimization_odh-user[Deployment strategies for resource optimization].
endif::[]
. Click *Deploy*.
