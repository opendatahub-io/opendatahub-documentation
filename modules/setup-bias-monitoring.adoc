...
Depending on how your cluster was created, you might need to enable a User Workload Monitoring setting from your {openshift-platform} (for example, on link:console.redhat.com[console.redhat.com]).
