...
[IMPORTANT]
====
To ensure the runtime configuration is created automatically, you must have created the pipeline server before you created the workbench.
====
* You have created and launched a workbench using a notebook image that contains the Elyra extension (Standard data science, TensorFlow, TrustyAI, or PyTorch).
