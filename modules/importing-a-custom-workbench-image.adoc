...
ifdef::upstream[]
* The *Settings* -> *Environment setup* -> *Workbench images* dashboard navigation menu item is enabled, as described in link:{odhdocshome}/managing-odh/#enabling-custom-images_custom-images[Creating a custom image from a default {productname-short} image].
endif::[]
ifndef::upstream[]
* The *Settings* -> *Environment setup* -> *Workbench images* dashboard navigation menu item is enabled, as described in link:{rhoaidocshome}{default-format-url}/managing_openshift_ai/creating-custom-workbench-images#enabling-custom-images_custom-images[Enabling custom workbench images in {productname-short}].
endif::[]
ifndef::upstream[]
