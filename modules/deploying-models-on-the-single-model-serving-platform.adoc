...
[role='_abstract']
When you have enabled the single model serving platform, you can enable the standalone TGIS or composite Caikit-TGIS runtimes that this platform uses and start to deploy models on the platform.
