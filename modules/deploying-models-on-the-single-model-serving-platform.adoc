...
.. From the *Model location* list, specify where you model is stored and complete the connection detail fields. 
+
[NOTE]
====
...
[NOTE]
====
You must add your model as as an AI asset endpoint to test your model in the GenAI Playground.
====
