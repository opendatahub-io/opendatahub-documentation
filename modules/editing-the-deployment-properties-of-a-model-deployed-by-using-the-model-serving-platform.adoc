...
[id="editing-the-deployment-properties-of-a-model-deployed-by-using-the-model-serving-platform_{context}"]
= Editing the deployment properties of a model deployed by using the model serving platform
