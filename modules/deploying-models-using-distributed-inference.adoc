...
ifdef::upstream[]
* You have enabled authentication as described in link:{odhdocshome}/deploying-models/configuring-authentication-for-llmd[Configuring authentication for {llmd}].
endif::[]

ifndef::upstream[]
* You have enabled authentication as described in link:{rhoaidocshome}{default-format-url}/deploying_models/configuring-authentication-for-llmd_deploying-models[Configuring authentication for {llmd}].
endif::[]
