...
.Procedure
. In the JupyterLab interface, click the *Git* button (image:{site-baseurl}/assets/img/pages/docs/images/jupyter-git-sidebar.png[Git button]).
. Click the *Pull latest changes* button (image:{site-baseurl}/assets/img/pages/docs/images/jupyter-git-pull-button.png[Pull latest changes button]).
