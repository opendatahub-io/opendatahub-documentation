...
ifndef::upstream[]
For more information on how to format object storage endpoints, see link:{rhoaidocshome}{default-format-url}/managing-resources/#overview-of-object-storage-endpoints[Overview of object storage endpoints].
endif::[]
