...
ifdef::upstream[]
For more information on how to format object storage endpoints, see 
link:{odhdocshome}/managing-resources/#overview-of-object-storage-endpoints[Overview of object strange endpoints]
endif::[]
ifndef::upstream[]
For more information on how to format object storage endpoints, see 
link:{rhoaidocshome}/managing-resources/#overview-of-object-storage-endpoints[Overview of object strange endpoints]
endif::[]
