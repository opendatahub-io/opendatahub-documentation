...
ifdef::self-managed[]
See also link:{rhodsdocshome}{default-format-url}/installing_and_uninstalling_{url-productname-short}/accessing-data-science-dashboard_install[Accessing the {productname-short} dashboard].
endif::[]
endif::[]
