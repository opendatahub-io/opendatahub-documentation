...
ifdef::self-managed[]
See also link:{rhodsdocshome}{default-format-url}/installing_and_uninstalling_openshift_data_science_self-managed/accessing-data-science-dashboard_install[Accessing the {productname-short} dashboard].
endif::[]
endif::[]
