...
* Access and manage pipeline applications for any data science project.
|===
...
* Managing AI pipeline servers and pipeline applications from the {productname-short} dashboard, or from the command-line interface (CLI), for any data science project. 
