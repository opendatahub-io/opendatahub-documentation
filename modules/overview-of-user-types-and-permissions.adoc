...
ifdef::cloud-service[]
See also link:https://access.redhat.com/documentation/en-us/openshift_dedicated/4/html/cluster_administration/index[OpenShift Dedicated Cluster administration] or link:https://access.redhat.com/documentation/en-us/red_hat_openshift_service_on_aws/4/html/cluster_administration/index[Red Hat OpenShift Service on AWS (ROSA) Cluster administration].
endif::[]
