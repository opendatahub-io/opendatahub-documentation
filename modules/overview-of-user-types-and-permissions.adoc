...
* Creating a data science pipeline server and pipeline from the {productname-short} user interface or from the command-line interface (CLI), for any data science project. 
