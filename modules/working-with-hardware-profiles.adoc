...
After you create and enable a hardware profile, you can select it when you deploy resources such as workbenches and model-serving workloads. This capability enables precise targeting of your workloads to specific nodes that have the required hardware, which ultimately improves resource management efficiency.
