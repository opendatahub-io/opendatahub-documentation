...
ifndef::upstream[]
For instructions on deploying PostgreSQL with the pgvector extension, see link:{rhoaidocshome}{default-format-url}/working_with_llama_stack/index#deploying-a-postgresql-instance-with-pgvector_rag[Deploying a PostgreSQL instance with pgvector].
endif::[]