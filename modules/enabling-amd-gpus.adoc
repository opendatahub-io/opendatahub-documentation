...
* If you are running in a public cloud, you have verified that your compute platform provides AMD GPUs supported by the AMD GPU Operator and ROCm. Verify instance and VM types and GPU models against the link:https://instinct.docs.amd.com/projects/gpu-operator/en/latest/index.html#compatibility[AMD GPU Operator support matrix].
endif::[]
ifdef::cloud-service[]
