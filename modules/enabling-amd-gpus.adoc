...
//upstream only
ifdef::upstream[]
. After installing the AMD GPU Operator, create a hardware profile, as described in link:{odhdocshome}/working-with-accelerators/#working-with-accelerator-profiles_accelerators[Working with hardware profiles].
endif::[]
