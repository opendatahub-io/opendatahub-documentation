...
ifdef::upstream[]
If you are using Jupyter, see link:{odhdocshome}/working-on-data-science-projects/#updating-notebook-server-settings-by-restarting-your-server_nb-server[Updating notebook server settings by restarting your server].
