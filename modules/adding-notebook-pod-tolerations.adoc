...
ifndef::upstream[]
If you are using Jupyter, see link:{rhoaidocshome}{default-format-url}/working-with-connected-applications/using_the_jupyter_application#updating-notebook-server-settings-by-restarting-your-server_connected-apps[Updating notebook server settings by restarting your server].
If you are using a workbench in a data science project, see link:{rhoaidocshome}{default-format-url}/working-on-data-science-projects/using-project-workbenches_projects#starting-a-workbench_projects[Starting a workbench].
endif::[]
