...
* You have a PostgreSQL database with the pgvector extension enabled. You can use a single PostgreSQL instance for both pgvector and Llama Stack metadata storage, or maintain them as separates instances. 
