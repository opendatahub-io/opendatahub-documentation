...
* You have a PostgreSQL database with the pgvector extension enabled. The PostgreSQL database used for pgvector can be the same instance used for Llama Stack metadata storage or a separate instance.
