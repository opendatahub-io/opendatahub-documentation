...
* To deploy a model version by using the multi-model serving platform, you have fulfilled the prerequisites described in link:{rhoaidocshome}{default-format-url}/deploying_models/rhoai-user_rhoai-user#deploying-a-model-using-the-multi-model-serving-platform_rhoai-user[Deploying a model by using the multi-model serving platform].
endif::[]
