...
ifndef::upstream[]
See link:{rhoaidocshome}{default-format-url}/deploying_models/rhoai-user_rhoai-user#vllm_servingruntime_for_kserve[vLLM NVIDIA GPU ServingRuntime for KServe^].
endif::[]
ifdef::upstream[]
See link:{odhdocshome}/deploying-models/#_vllm_servingruntime_for_kserve[vLLM NVIDIA GPU ServingRuntime for KServe^].
endif::[]
