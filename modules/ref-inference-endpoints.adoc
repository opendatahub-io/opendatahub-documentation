...
ifndef::upstream[]
See link:{rhoaidocshome}{default-format-url}/deploying_models/rhoai-user_rhoai-user#_vllm_nvidia_gpu_servingruntime_for_kserve[vLLM NVIDIA GPU ServingRuntime for KServe^].
endif::[]
ifdef::upstream[]
