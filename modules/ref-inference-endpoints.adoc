...
ifdef::upstream[]
* link:{odhdocshome}/serving-models/#supported-runtimes_serving-large-models[Supported runtimes]
endif::[]
ifndef::upstream[]
* link:{rhoaidocshome}{default-format-url}l/serving_models/serving-large-models_serving-large-models#supported-model-serving-runtimes_serving-large-models[Supported runtimes]
endif::[]
