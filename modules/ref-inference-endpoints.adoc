...
----
grpcurl -insecure \
        -cacert ./openshift_ca_istio_knative.crt \
...
ifndef::upstream[]
----
grpcurl -insecure -cacert ./openshift_ca_istio_knative.crt -proto ./grpc_predict_v2.proto -d @ -H "Authorization: Bearer <token>" <inference_endpoint_url>:443 inference.GRPCInferenceService/ModelMetadata
----
endif::[]
