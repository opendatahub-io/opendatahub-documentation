...
| OpenVINO Model Server | A scalable, high-performance runtime for serving models that are optimized for Intel architectures | PyTorch, TensorFlow, OpenVINO IR, PaddlePaddle, MXNet, Caffe, Kaldi | v1 | v2 | RHOAI 2.11: 2024.1 
...
| vLLM | A high-throughput and memory-efficient inference and serving runtime for large language models | link:https://docs.vllm.ai/en/latest/models/supported_models.html[Supported models^] | OpenAI API | OpenAI API| RHOAI 2.11: v0.5.0.post1-99-g8720c92e and v 0.5 .0.post1 
|===
...
// link to endpoints and examples
