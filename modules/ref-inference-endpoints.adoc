...
ifdef::upstream[]
* link:{odhdocshome}/serving-models/serving-large-models/ref-supported-runtimes[Supported runtimes]
endif::[]

ifndef::upstream[]
* link:{rhoaidocshome}{default-format-url}/serving-models/serving-large-models/ref-supported-runtimes[Supported runtimes]
endif::[]
