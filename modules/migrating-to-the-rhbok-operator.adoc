...
====
.. In the web console, click *Ecosystem* -> *Installed Operators* and then click the {productname-long} Operator.
...
.. Go to *Ecosystem* -> *Installed Operators* and confirm that the {rhbok-productname} Operator is listed with *Status* as *Succeeded*.
