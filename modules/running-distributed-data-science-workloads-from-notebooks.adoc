...
+
A ROCm-compatible Ray cluster image `quay.io/modh/ray:2.35.0-py39-rocm61` is available as Developer Preview software.
This image is also an AMD64 image, which might not work on other architectures.
+
[IMPORTANT]
====
