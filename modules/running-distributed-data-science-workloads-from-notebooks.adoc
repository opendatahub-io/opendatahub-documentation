...
+
You can use the `codeflare_sdk.list_local_queues()` function to view all local queues, and the resource flavors associated with each local queue, in your current namespace.
+
