...
+
* If you enabled *Make deployed models available through an external route* during model deployment, click *Endpoint details* on the *Deployments* page in the {productname-short} dashboard to obtain your model endpoint URL.
