...
.3+|Vector_IO | `inline::faiss` |Set the `ENABLE_FAISS` environment variable |No |Technology Preview
...
|`remote::pgvector` |Set the `ENABLE_PGVECTOR` environment variable |No |Technology Preview
|===