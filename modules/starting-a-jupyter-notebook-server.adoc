...
ifndef::upstream[]
Ask your administrator to add you to the correct group by using link:{rhoaidocshome}{default-format-url}/managing-users/adding-users_user-mgmt[Adding users].
endif::[]
ifdef::upstream[]
