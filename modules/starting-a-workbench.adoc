...
[role='_abstract']
You can manually start a data science project's workbench from the project details page. By default, workbenches start immediately after you create them.
