...
ifndef::upstream[]
To compare runs from different experiments or pipelines, or to view every pipeline run in a project, see link:{rhoaidocshome}{default-format-url}/working_with_ai_pipelines/managing-pipeline-experiments_ai-pipelines#comparing-runs-in-different-experiments_ai-pipelines[Comparing runs in different experiments].
endif::[]
ifdef::upstream[]
To compare runs from different experiments or pipelines, or to view every pipeline run in a project, see link:{odhdocshome}/working-with-ai-pipelines/#comparing-runs-in-different-experiments_ai-pipelines[Comparing runs in different experiments].
endif::[]
...
.Procedure
. In the {productname-short} dashboard, select *Develop & train* -> *Experiments*.
+ 
