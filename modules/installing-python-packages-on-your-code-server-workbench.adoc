...
ifndef::upstream[]
See link:{rhoaidocshome}{default-format-url}/working_in_your_data_science_ide/working_in_code_server#viewing-python-packages-installed-on-your-code-server-workbench_ide[Viewing Python packages installed on your code-server workbench] for details.
endif::[]
ifdef::upstream[]
See link:{odhdocshome}/working-in-your-data-science-ide/#managing-python-packages-in-code-server_ide[Viewing Python packages installed on your code-server workbench] for details.
endif::[]