...
ifdef::upstream[]
* You are familiar with how to link:{site-baseurl}/docs/working-on-data-science-projects/#configuring-a-model-server-for-your-data-science-project_nb-server[configure a model server for your project]. When you have added a custom model-serving runtime, you must configure a new model server to use the runtime.
endif::[]
ifndef::upstream[]
...
ifdef::upstream[]
* To learn how to configure a model server that uses a custom model-serving runtime that you have added, see link:{site-baseurl}/docs/working_on_data_science_projects#configuring-a-model-server-for-your-data-science-project_nb-server[Configuring a model server for your data science project].
endif::[]
ifndef::upstream[]
