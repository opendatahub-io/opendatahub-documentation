...
ifndef::upstream[]
*Note:* The Jupyter tile is enabled by default. To disable it, see link:{rhoaidocshome}{default-format-url}/managing-resources/#hiding-the-default-jupyter-application_dashboard[Hiding the default Jupyter application].
endif::[]
ifdef::upstream[]
