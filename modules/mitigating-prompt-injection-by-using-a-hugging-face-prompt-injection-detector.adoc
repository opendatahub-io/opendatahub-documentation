...
ifdef::upstream[]
* You are familiar with how to configure and deploy the Guardrails Orchestrator service. See xref:#deploying-the-guardrails-orchestrator-service_safety[Deploying the Guardrails Orchestrator].
endif::[]
ifndef::upstream[]
* You are familiar with how to configure and deploy the Guardrails Orchestrator service. See xref:#deploying-the-guardrails-orchestrator-service_safety[Deploying the Guardrails Orchestrator]
endif::[]
