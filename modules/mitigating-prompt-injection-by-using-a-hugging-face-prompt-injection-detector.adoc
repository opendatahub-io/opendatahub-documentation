...
[id="mitigating-prompt-injection-by-using-a-hugging-face-prompt-injection-detector_{context}"]
...
ifdef::upstream[]
* You are familiar with how to configure and deploy the Guardrails Orchestrator service. See link:{odhdocshome}/enabling-ai-safety#deploying-the-guardrails-orchestrator-service_safety[Deploying the Guardrails Orchestrator].
endif::[]
ifndef::upstream[]
* You are familiar with how to configure and deploy the Guardrails Orchestrator service. See link:{rhoaidocshome}{default-format-url}/enabling_ai_safety/enabling-ai-safety_safety#deploying-the-guardrails-orchestrator-service_safety[Deploying the Guardrails Orchestrator].
endif::[]
