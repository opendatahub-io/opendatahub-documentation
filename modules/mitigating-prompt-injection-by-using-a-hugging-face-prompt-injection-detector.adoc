...
ifndef::upstream[]
* You are familiar with how to configure and deploy the Guardrails Orchestrator service. See link:{rhoaidocshome}{default-format-url}/enabling_ai_safety/enabling-ai-safety-with-guardrails_safety#deploying-the-guardrails-orchestrator-service_safety[Deploying the Guardrails Orchestrator] 
endif::[]
