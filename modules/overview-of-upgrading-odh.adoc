...
To resolve this issue, you can create a new model registry instance that points to the same backing database, and delete the old model registry. Your new model registry instance will retain all existing registered models and their metadata. 
====
endif::[]