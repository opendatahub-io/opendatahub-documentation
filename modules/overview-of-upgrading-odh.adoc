...
NOTE: Model registry names must be unique. If you want to use the same model registry name as your original registry, you must delete the original registry before creating the new one.
====
endif::[]