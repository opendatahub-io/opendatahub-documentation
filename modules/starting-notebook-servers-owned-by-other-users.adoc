...
* You have launched the Jupyter application, as described in link:{odhdocshome}/getting_started_with_open_data_hub/#launching-jupyter-and-starting-a-notebook-server_get-started[Launching Jupyter and starting a notebook server].
endif::[]
...
ifdef::upstream[]
* link:{odhdocshome}/getting_started_with_{url-productname-long}/#options-for-notebook-server-environments_get-started[Options for notebook server environments]
endif::[]
