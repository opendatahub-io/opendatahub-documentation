...
[IMPORTANT]
=====
The RAG feature of the GenAI playground is currently configured to work only with an inline vector database. There is currently no mechanism to configure the playground to connect this RAG feature to an external or remote vector database.
=====
...
. Optional: Adjust the *Maximum chunk length* and *Chunk overlap* and *Delimiter* values as needed for your document type. For more information about these settings, see _Understanding RAG settings_.
. Click *Upload*.
+
