...
----
$ oc logs -n {dbd-config-default-namespace} -l app.kubernetes.io/name=maas-api
----
...
[source,terminal,subs="+attributes"]
----
$ oc logs -n {dbd-config-default-namespace} -l app.kubernetes.io/name=maas-api --tail=50 | grep tier
----
