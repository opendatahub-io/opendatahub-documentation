...
ifndef::upstream[]
.. Change the values of the fields as needed. For a description of these fields, see link:{rhoaidocshome}{default-format-url}/monitoring_your_ai_systems/monitoring-model-bias_bias-monitoring#creating-a-bias-metric-using-dashboard_bias-monitoring[Creating a bias metric by using the dashboard].
endif::[]
ifdef::upstream[]
.. Change the values of the fields as needed. For a description of these fields, see link:{odhdocshome}/monitoring-your-ai-systems/#creating-a-bias-metric-using-dashboard_bias-monitoring[Creating a bias metric by using the dashboard].
endif::[]
