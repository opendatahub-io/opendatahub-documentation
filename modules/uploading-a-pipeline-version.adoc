...
* If your pipeline version is based on Python code, compile it to YAML before uploading. For more information, see _Generating the pipeline YAML with the Kubeflow Pipelines SDK_.
