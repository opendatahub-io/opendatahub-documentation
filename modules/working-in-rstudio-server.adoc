...
See link:{rhoaidocshome}{default-format-url}/working_on_data_science_projects/working-in-your-data-science-ide/#building_the_rstudio_server_notebook_images[Building the RStudio Server notebook images] for more information.
+
[IMPORTANT] 
====
*Disclaimer:* 
