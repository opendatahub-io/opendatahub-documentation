...
. In the `spec.components`, set the value of the `managementState` field for `monitoring` to `Managed`, and configure metrics, alerting, and tracing components, as shown in the following example:
+
