...
For examples using multi-node deployments, see 
You can use the following examples for multi-node deployments link:https://github.com/red-hat-data-services/kserve/blob/main/docs/samples/llmisvc/dp-ep/deepseek-r1-gpu-rdma-roce/README.md[DeepSeek-R1 Multi-Node Deployment Examples].
