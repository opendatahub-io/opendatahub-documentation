...
. In the *Archive version?* dialog that is displayed, enter the name of the model version in the text field to confirm that you intend to archive it.
. Click *Archive*.

.Verification
* The model version no longer is displayed on the details page for the model.
* The model version now is displayed on the archived versions page for the model.
