...
[role='_abstract']
You can update your project's model server by changing details, such as the number of deployed replicas, the server size, the token authentication, and how to access the project. If you require extra power for use with large datasets, you can update you can assign accelerators to your model server to optimize performance.

.Prerequisites
* You have logged in to {productname-long}.
* You have created a project that has a model server assigned.
...
.Verification
* The model server that you updated is displayed on the *Deployments* tab for the project.
