...
This implementation of Llama Stack combines link:https://github.com/foundation-model-stack/fms-guardrails-orchestrator[Guardrails Orchestrator] with a suite of community-developed detectors to provide robust content filtering and safety monitoring. 
...
NOTE: You must uninstall Red Hat OpenShift Service Mesh, version 2.6.7-0 or later, from your cluster.
