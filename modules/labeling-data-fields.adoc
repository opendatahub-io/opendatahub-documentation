...
ifdef::upstream[]
* You sent training data to TrustyAI as described in link:{odhdocshome}/monitoring-your-ai-systems/#sending-training-data-to-trustyai_monitor[Sending training data to TrustyAI].
endif::[]
