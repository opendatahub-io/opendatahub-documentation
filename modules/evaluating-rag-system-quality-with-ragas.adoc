...
`client.datasets.unregister("<my_rag_evaluation>")
    print(f"Dataset '<my_rag_evaluation>' unregistered successfully")`
====
+
[source,python]
----
client.datasets.register(
    dataset_id="<my_rag_evaluation>",
    purpose="eval/question-answer",
    source={"type": "rows", "rows": evaluation_data},
    metadata={
        "provider_id": "localfs",
        "description": "Sample RAG evaluation dataset for Ragas",
...
client.benchmarks.register(
    benchmark_id="<ragas_benchmark_inline/remote>",
    dataset_id="<my_rag_evaluation>",
    scoring_functions=[
    ...
    provider_id="<trustyai_ragas_inline/remote>",
        # metadata={
        #     "provider": "ragas",
        #     "version": "1.0",
