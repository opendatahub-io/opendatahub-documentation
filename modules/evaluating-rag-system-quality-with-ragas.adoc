...
ifdef::upstream[]
For more information, see link:{odhdocshome}/evaluating-ai-systems/#configuring-ragas-remote-provider-for-production_monitor[Configuring the Ragas remote provider for production].
endif::[]
ifndef::upstream[]
