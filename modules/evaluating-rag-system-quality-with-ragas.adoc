...
[role='_abstract']
Evaluate your RAG system quality by testing your setup, using the example provided in the link:https://github.com/trustyai-explainability/llama-stack-provider-ragas/blob/main/demos/basic_demo.ipynb[demo notebok], which outlines the basic steps for evaluating your RAG system with Ragas using the python client. You can execute the demo notebook steps from a Jupyter environment. 
