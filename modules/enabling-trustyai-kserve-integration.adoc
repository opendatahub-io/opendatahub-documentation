...
ifdef::upstream[]
For more information about deployment modes, see link:link:{odhdocshome}/docs/serving-models/#about-kserve-deployment-modes_serving-large-models[About KServe deployment modes].
endif::[]
ifndef::upstream[]
...
----
+
. Use the following code to create a ConfigMap in your model's namespace to hold the CA certificate:
+
[source,json]
----   
  apiVersion: v1
