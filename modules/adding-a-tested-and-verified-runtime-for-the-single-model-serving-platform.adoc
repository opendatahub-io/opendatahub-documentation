...
ifndef::upstream[]
* link:{rhoaidocshome}{default-format-url}/configuring_your_model_serving_platform/rhoai-admin_rhoai-admin#tested-verified-runtimes_rhoai-admin[Tested and verified model-serving runtimes]
endif::[] 
ifdef::upstream[]
