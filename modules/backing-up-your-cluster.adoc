...
ifdef::cloud-service[]
For more information, see link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws_classic_architecture/{rosa-classic-latest-version}/html/backing_up_and_restoring_applications/index[Backing up and restoring applications] in the {rosa-classic-productname} documentation.
endif::[]
