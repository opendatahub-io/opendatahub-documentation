...
** A workbench image for Intel Gaudi accelerators is not included in {productname-short}. Instead, you must create and configure a custom notebook to enable Intel Gaudi AI support.
