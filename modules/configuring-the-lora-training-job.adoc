...
|`target_modules`
|Names of the modules to apply LoRA to; includes ‘q_proj” and ‘v_prod’ by default
...
. Click *ConfigMaps* and verify that the `lora-config` and `twitter-complaints` ConfigMaps are listed. 
