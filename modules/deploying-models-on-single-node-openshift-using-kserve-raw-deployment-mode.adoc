...
[NOTE]
====
For IBM Z and IBM Power, vLLM runtime is supported only on CPU. For more information, see the link:https://www.google.com/url?q=https://access.redhat.com/solutions/7109527&sa=D&source=docs&ust=1744140804473098&usg=AOvVaw3qOPqGpsOu6M6Iev-Chupa[Red{nbsp}Hat {openshift-platform} Multi Architecture Component Availability Matrix].
====
endif::[]
ifdef::upstream[]
