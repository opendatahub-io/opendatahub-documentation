...
ifndef::upstream[]
* Your administrator has disabled the application that you want to remove, as described in link:{rhoaidocshome}{default-format-url}/managing-resources/managing-applications-that-show-in-the-dashboard/#disabling-applications-connected_dashboard[Disabling applications connected to {productname-short}].
endif::[]
ifdef::upstream[]
