...
ifndef::upstream[]
* Your administrator has disabled the application that you want to remove, as described in link:{rhoaidocshome}{default-format-url}/managing_resources/disabling-applications-connected_managing-resources[Disabling applications connected to {productname-short}].
endif::[]
ifdef::upstream[]
