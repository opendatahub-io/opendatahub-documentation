...
.Next Step
ifdef::upstream[]
Configure the distributed workloads feature as described in link:{odhdocshome}/managing_openshift_ai#managing_distributed_workloads_cluster-admin[Managing distributed workloads].
endif::[]
ifndef::upstream[]
