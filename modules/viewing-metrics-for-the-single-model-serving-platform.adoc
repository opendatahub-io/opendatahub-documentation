...
.. The following query displays the number of successful inference requests over a period of time for a model deployed with the Caikit embeddings runtime:
+
[source,subs="+quotes"]
----
