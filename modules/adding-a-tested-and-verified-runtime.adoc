...
[id="adding-a-tested-and-verified-runtime_{context}"]

= Adding a tested and verified runtime
...
You can use the {productname-long} dashboard to add and enable tested and verified runtimes for the model serving platform. You can then choose the runtime when you deploy a model on the model serving platform.
