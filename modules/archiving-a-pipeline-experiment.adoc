...
.Verification
* The archived pipeline experiment does not appear on the *Experiments* tab, and instead appears in the *Archive* tab on the *Experiments* page for the pipeline experiment.
