...
ifndef::upstream[]
If you are using a basic workbench, see link:{rhoaidocshome}{default-format-url}/working_with_connected_applications/using_the_jupyter_application#updating-workbench-settings-by-restarting-your-workbench_connected-apps[Updating workbench settings by restarting your workbench].
