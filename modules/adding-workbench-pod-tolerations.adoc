...
If you are using a workbench in a project, see link:{odhdocshome}/working-on-projects/#starting-a-workbench_projects[Starting a workbench].
endif::[]
...
If you are using a workbench in a project, see link:{rhoaidocshome}{default-format-url}/working_on_projects/using-project-workbenches_projects#starting-a-workbench_projects[Starting a workbench].
endif::[]
...
. In the {openshift-platform} console, select your project, then click *Workloads* -> *StatefulSet*. You can see how many pods are running, either zero or one, depending on whether your workbench is currently started or stopped. 
