...
include::modules/llama-stack-apis.adoc[leveloffset=+2]
include::modules/openai-compatible-apis-in-llama-stack.adoc[leveloffset=+2]
include::modules/openai-compatibility-for-rag-apis-in-llama-stack.adoc[leveloffset=+3]
include::modules/llama-stack-providers-support.adoc[leveloffset=+2]
...
include::assemblies/using-the-generative-ai-playground.adoc[leveloffset=+1]
