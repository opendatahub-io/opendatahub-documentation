...
include::modules/creating-an-internal-registry.adoc[leveloffset=+2]

include::modules/adding-default-inbox-drivers-to-a-denylist.adoc[leveloffset=+2]

include::modules/verifying-amd-gpu-availability-on-your-cluster.adoc[leveloffset=+2]

include::modules/installing-the-amd-gpu-operator.adoc[leveloffset=+2]
