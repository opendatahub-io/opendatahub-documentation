...
include::modules/creating-a-hardware-profile-for-workload-queuing.adoc[leveloffset=+2]

include::modules/launching-a-workload-with-a-kueue-hardware-profile.adoc[leveloffset=+2]
