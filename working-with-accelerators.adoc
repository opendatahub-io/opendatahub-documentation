...
Use accelerators or accelerated hardware, such as NVIDIA GPUs, AMD GPUs, and Intel Gaudi AI accelerators, to optimize the performance of your end-to-end data science workflows. 
...
include::modules/ibm-spyre-integration.adoc[leveloffset=+1]

include::modules/enabling-ibm-spyre.adoc[leveloffset=+2]
