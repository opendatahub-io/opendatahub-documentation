...
As an OpenShift cluster administrator, if the model registry was not enabled in a previous {productname-short} version, after upgrading, you can enable this component for {productname-short} administrators and data scientists to use. 
