...
As a data scientist in {productname-short}, you can discover and evaluate the generative AI models that are available in the model catalog for your organization to register, deploy, and customize. 
