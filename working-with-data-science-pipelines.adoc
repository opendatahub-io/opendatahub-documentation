...
//Managing pipeline experiments (To be written for a future release)
// create a new assembly and include these modules:
...
//include::modules/updating-a-pipeline-experiment.adoc[leveloffset=+1] 
//include::modules/deleting-a-pipeline-experiment.adoc[leveloffset=+1] 
