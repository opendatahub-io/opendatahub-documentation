...
:rosa-classic-latest-version: 4
:os-latest-version: 1.36
:rhelai-productname-long: Red{nbsp}Hat Enterprise Linux AI
:rhelai-productname-short: RHEL AI
:rhbok-productname: Red Hat build of Kueue
:rhbok-docs: https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html/ai_workloads/red-hat-build-of-kueue
:rosa-productname: Red{nbsp}Hat OpenShift Service on AWS
:rosa-classic-productname: Red{nbsp}Hat OpenShift Service on AWS (classic architecture)
:openshift-cli: pass:quotes[OpenShift CLI (`oc`)]
:llmd: distributed inference with llm-d